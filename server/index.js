...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.ca9ev.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
  try {
    //! Collections
    const usersCollection = client.db("CookEase").collection("users");
    const allMealsCollection = client.db("CookEase").collection("mealplans");
